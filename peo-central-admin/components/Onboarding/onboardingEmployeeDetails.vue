            ...
            <template v-slot:item="{ item, index }">
              <tr>
                ...
                <td class=" d-flex align-center">
                  <img :src="item.company_logo || '#'" style="border-radius: 10px" width="30" height="30" v-if="index === 0 && item.company_logo"
                    class="mr-2" />
          ...
          <v-data-table id="coa_table" class="main__table elevation-0 customDataTabel  th_customer mb-5"
            ...
            <template v-slot:item="{ item, }">
              ...
              <tr>
                ...
                <td class="pb-2 pt-2">{{ item.personal && item.personal.phone ? item.personal.phone : '-' }} </td>
                <td class=""> </td>
              </tr>
            </template>
          </v-data-table>
          ...
          <v-data-table id="coa_table" class="main__table elevation-0 customDataTabel  th_customer mb-5 mt-5"
            ...
            <template v-slot:item="{ item, }">
              <tr>
                ...
                <td class=" d-flex align-center">
                  {{ item.designation || item.employment?.designation || '-' }}
                </td>
                <td class=""> </td>
              </tr>
              <tr>
                ...
                <td class=" d-flex align-center">
                  {{ item.date_of_joining || item.employment?.date_of_joining || '-' }}
                </td>
                <td class=""> </td>
              </tr>
               <tr>
                ...
                <td class=" d-flex align-center">
                  {{ item.end_date || item.employment?.end_date || '-' }}
                </td>
                <td class=""> </td>
              </tr>
              <tr>
                ...
                <td class=" d-flex align-center" v-if="item.employment">
                  {{ item.employment && item.employment.probation_period ? item.employment.probation_period : '-' }}
                </td>
                <td class=""> </td>
              </tr>
              <tr>
                ...
                <td class=" d-flex align-center" v-if="item.employment">
                  {{ item.employment && item.employment.notice_period ? item.employment.notice_period : '-' }}
                </td>
                <td class=""> </td>
              </tr>
              <tr>
                ...
                <td class=" d-flex align-center" v-if="item.employment">
                  {{ item.employment && item.employment.working_days ? item.employment.working_days : '-' }}
                </td>
                <td class=""> </td>
              </tr>
              <tr>
                ...
                <td class=" d-flex align-center" v-if="item.employment">
                  {{ item.employment && item.employment.contract_type ? item.employment.contract_type : '-' }}
                </td>
                <td class=""> </td>
              </tr>
            </template>
            ...
            <template v-slot:item="{ item, }">
              <tr>
                ...
                <td class=" d-flex align-center" v-if="item.payroll_details">
                  {{ item.payroll_details && item.payroll_details.invoice_date ? item.payroll_details.invoice_date : '-' }}
                </td>
                <td class=""> </td>
              </tr>
              <tr>
                {{ item.payroll_details }}
                <td class="pr-0" style="width: 215px !important;">Payment Due Date</td>
                <td class=" d-flex align-center" v-if="item.payroll_details">
                  {{ item.payroll_details && item.payroll_details.payment_due_notification ? item.payroll_details.payment_due_notification : '-' }}
                </td>
                <td class=""> </td>
              </tr>
              <tr>
                ...
                <td class=" d-flex align-center" v-if="item.payroll_details">
                  {{ item.payroll_details && item.payroll_details.salary_payment_date ? item.payroll_details.salary_payment_date : '-' }}
                </td>
                <td class=""> </td>
              </tr>
            </template>
