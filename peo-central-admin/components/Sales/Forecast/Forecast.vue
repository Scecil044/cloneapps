          ...
          <v-container class="ma-0 pa-0">
            ...
            <div class="other_filters mt-2">
              <v-row>
                ...
                ></v-col>
                <v-col cols="6" class="ma-0 pa-0"
                  ><v-select :items="customerFilter" label="All"></v-select
                ></v-col>
                <v-col cols="6" class="ma-0 pa-0"
                  ><v-checkbox color="primary" label="Status"></v-checkbox
                ></v-col>
                <v-col cols="6" class="ma-0 pa-0"
                  ><v-select :items="statusFilter" label="Paid"></v-select
                ></v-col>
              </v-row>
            </div>
                      ...
                      <v-list>
                        <v-list-item>
                          <v-list-item-title class="">
                            <span class="n_text text--text mx-auto"
                              >No Action
                            </span>
                          </v-list-item-title>
                        </v-list-item>
  ...
  data() {
    return {
      ...
      total_forecast: [
        ...
        { name: 'Monthly Reoccurring Revenue', amount: '0' },
      ],
      forecast_titles: [
