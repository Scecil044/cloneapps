<template>
  <v-row>
    ...
    <v-col cols="12" v-else>
      <v-card color="card_bg" id="card" style="max-height: 85vh">
...
export default {
  ...
  methods: {
    ...
    async getInsurance(user) {
      ...
      await this.$axios.$post(process.env.insurancePortalUrl + 'insurance/cycles/external/getdetails', { "user_id": user, "parent_company": this.parent_company }, { headers: { Authorization: AuthStr } })
        .then((res) => {
