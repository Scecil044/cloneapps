<template>
  <div class="tw-mb-6">
    <!-- Stats Cards Grid -->
    <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 md:tw-grid-cols-3 lg:tw-grid-cols-4 xl:tw-grid-cols-5 2xl:tw-grid-cols-6 tw-gap-3 tw-mb-6">
      <div
