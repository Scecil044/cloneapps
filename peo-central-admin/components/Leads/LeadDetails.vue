      ...
      <v-col cols="12">
        <v-card color="card_bg" id="card">
          ...
          <v-card-text id="card-text2" style="max-height: 600px !important" class="dl__l overflow-y-auto">
            ...
            <v-data-table id="coa_table" class="main__table elevation-0 customDataTabel th_customer mb-5 mt-5"
              ...
              <template #[`item`]="{ item }">
                ...
                <tr>
                  ...
                  <td class="d-flex align-center">{{ item.lead_details.lead_received ? item.lead_details.lead_received : '-' }} Days</td>
                  <td class=""></td>
                </tr>
              </template>
            </v-data-table>
            ...
            <v-data-table id="coa_table" class="main__table elevation-0 customDataTabel th_customer mb-5 mt-5"
              :headers="leadCompanyHeaders" :items="leadsDetails"
              :footer-props="{ 'items-per-page-options': [10, 20] }" hide-default-footer default-sort="false">
              <template #[`header.title`]="{ header }">
                <div class="d-flex align-center pa-0">
                  <div>
              ...
              <template #[`item`]="{ item }">
                ...
                <tr>
                  ...
                  <td class="d-flex align-center">{{ item.contact_person.name ? item.contact_person.name : '-' }}</td>
                  <td class=""></td>
                </tr>
                <tr>
                  ...
                  <td class="d-flex align-center">
                    <div style="position: relative !important">
                      <v-img style=" position: absolute !important; width: 30px; bottom: 4px;" alt="Avatar" :src="getCountryFlag(item.contact_person.phone)" />
                      <span class="ml-9">{{  item.contact_person.phone }}</span>
                    </div>
                  </td>
                  <td class=""></td>
                </tr>
                <tr>
                  ...
                  <td class="d-flex align-center">{{ item.contact_person.email ? item.contact_person.email : '-' }}</td>
                  <td class=""></td>
                </tr>
                <tr>
                  <td class="pr-0" style="width: 215px !important">Company Website</td>
                  <td class="d-flex align-center">{{ item.website ? item.website : '-' }}</td>
                  <td class=""></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="d-flex align-center">{{ item.business_type ? item.business_type : '-' }}</td>
                  <td class=""></td>
                </tr>
                <tr>
            ...
            <v-data-table id="coa_table" class="main__table elevation-0 customDataTabel th_customer mb-5 mt-5"
              ...
              <template #[`item`]="{ item }">
                <tr>
                  ...
                  <td class="d-flex align-center">{{ item.lead_details.inquiry_type ? item.lead_details.inquiry_type : '-' }}</td>
                  <td class=""></td>
                </tr>
                <tr>
                  <td class="pr-0" style="width: 215px !important">Opportunity Type</td>
                  <td class="d-flex align-center">{{ item.lead_details.opportunity_type ? item.lead_details.opportunity_type : '-' }}</td>
                  <td class=""></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="d-flex align-center">{{ item.lead_details.rate_the_lead ? item.lead_details.rate_the_lead : '-' }}</td>
                  <td class=""></td>
                </tr>
                <tr>
                  <td class="pr-0" style="width: 215px !important">Overall Total Order Value</td>
                  <td class="d-flex align-center">{{ item.lead_details.overall_total_order_value ? item.lead_details.overall_total_order_value : '-' }}</td>
                  <td class=""></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="d-flex align-center">{{ item.lead_details.chance_rate ? item.lead_details.chance_rate : '-' }} %</td>
                  <td class=""></td>
                </tr>
                <tr>
                  <td class="pr-0" style="width: 215px !important">Committed Date</td>
                  <td class="d-flex align-center">{{ item.lead_details.committed_date ? item.lead_details.committed_date : '-' }}</td>
                  <td class=""></td>
                </tr>
                <tr>
                  <td class="pr-0" style="width: 215px !important">Mobilization Date</td>
                  <td class="d-flex align-center">{{ item.lead_details.mobilization_date ? item.lead_details.mobilization_date : '-' }}</td>
                  <td class=""></td>
                </tr>
                <tr>
                  <td class="pr-0" style="width: 215px !important">Opportunity Nick Name</td>
                  <td class="d-flex align-center">{{ item.lead_details.opportunity_nick_name ? item.lead_details.opportunity_nick_name : '-' }}</td>
                  <td class=""></td>
                </tr>
                <tr>
                  <td class="pr-0" style="width: 215px !important">Service Location</td>
                  <td class="d-flex align-center">{{ item.lead_details.service_location ? item.lead_details.service_location : '-' }}</td>
                  <td class=""></td>
                </tr>
              </template>
            </v-data-table>
...
export default {
  ...
  data() {
    return {
      ...
      leadDetails: [
        ...
        {
          title: 'Service Type',
          description: 'PEO Services',
        },
        {
          title: 'Service Offering',
          description: 'Nathan & NAthan',
        },
      ],
      ...
      leadRequirementDetails: [
        ...
        {
          title: 'Lead Received on',
          description: '25 Jan 2023',
        },
        {
          title: 'Days since Lead Received',
          description: '2 days - ',
      ...
      leadCompanyDetails: [
        ...
        {
          title: 'Email Address ',
          description: 'sunny@rgc.ae',
        },
        {
          title: 'Company Website',
          description: 'www.rgc.ae',
        },
        {
      ...
      leadExtraDetails: [
        ...
        {
          title: 'Overall Total Order Value',
          description: 'N/A',
        },
        {
          title: 'EOR Requirements',
          description: '10',
        },
        {
          title: 'Requirements',
        ...
        },
        {
          ...
          description: '23-03-2023',
        },
        {
          title: 'Opportunity Nick Name',
          description: 'N/A',
        },
        {
  ...
  methods: {
    ...
    async updateLeadsData(){
      this.showEditModel = !this.showEditModel
      // Emit event to parent component to refetch lead details
      this.$emit('lead-updated', this.leadsDetails[0]?._id)
