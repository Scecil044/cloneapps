module.exports = {
  ...
  darkMode: 'class', // Use 'class' for more control (or 'media' for system preference)
  theme: {
    extend: {
      fontFamily: {
  ...
  plugins: [],
  // Prevent conflicts with Vuetify
  prefix: 'tw-', // Optional: prefix all Tailwind classes to avoid conflicts
  important: true, // Makes Tailwind's classes override Vuetify
}
